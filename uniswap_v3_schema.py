...
uniswap_v3_schema = sgqlc.types.Schema()
...
class Position_orderBy(sgqlc.types.Enum):
    __schema__ = uniswap_v3_schema
    __choices__ = ('collectedFeesToken0', 'collectedFeesToken1', 'depositedToken0', 'depositedToken1', 'id', 'liquidity', 'owner', 'pool', 'tickLower', 'tickUpper', 'token0', 'token1', 'transaction', 'withdrawnToken0', 'withdrawnToken1')
...
class TickDayData_orderBy(sgqlc.types.Enum):
    __schema__ = uniswap_v3_schema
    __choices__ = ('date', 'feesUSD', 'id', 'liquidityGross', 'liquidityNet', 'pool', 'tick', 'volumeToken0', 'volumeToken1', 'volumeUSD')
...
class Tick_orderBy(sgqlc.types.Enum):
    __schema__ = uniswap_v3_schema
    __choices__ = ('collectedFeesToken0', 'collectedFeesToken1', 'collectedFeesUSD', 'createdAtBlockNumber', 'createdAtTimestamp', 'feesUSD', 'id', 'liquidityGross', 'liquidityNet', 'liquidityProviderCount', 'pool', 'poolAddress', 'price0', 'price1', 'tickIdx', 'untrackedVolumeUSD', 'volumeToken0', 'volumeToken1', 'volumeUSD')
...
class TickDayData_filter(sgqlc.types.Input):
    ...
    liquidity_gross = sgqlc.types.Field(BigDecimal, graphql_name='liquidityGross')
    liquidity_gross_not = sgqlc.types.Field(BigDecimal, graphql_name='liquidityGross_not')
    liquidity_gross_gt = sgqlc.types.Field(BigDecimal, graphql_name='liquidityGross_gt')
    liquidity_gross_lt = sgqlc.types.Field(BigDecimal, graphql_name='liquidityGross_lt')
    liquidity_gross_gte = sgqlc.types.Field(BigDecimal, graphql_name='liquidityGross_gte')
    liquidity_gross_lte = sgqlc.types.Field(BigDecimal, graphql_name='liquidityGross_lte')
    liquidity_gross_in = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(BigDecimal)), graphql_name='liquidityGross_in')
    liquidity_gross_not_in = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(BigDecimal)), graphql_name='liquidityGross_not_in')
    liquidity_net = sgqlc.types.Field(BigDecimal, graphql_name='liquidityNet')
    liquidity_net_not = sgqlc.types.Field(BigDecimal, graphql_name='liquidityNet_not')
    liquidity_net_gt = sgqlc.types.Field(BigDecimal, graphql_name='liquidityNet_gt')
    liquidity_net_lt = sgqlc.types.Field(BigDecimal, graphql_name='liquidityNet_lt')
    liquidity_net_gte = sgqlc.types.Field(BigDecimal, graphql_name='liquidityNet_gte')
    liquidity_net_lte = sgqlc.types.Field(BigDecimal, graphql_name='liquidityNet_lte')
    liquidity_net_in = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(BigDecimal)), graphql_name='liquidityNet_in')
    liquidity_net_not_in = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(BigDecimal)), graphql_name='liquidityNet_not_in')
    volume_token0 = sgqlc.types.Field(BigDecimal, graphql_name='volumeToken0')
    volume_token0_not = sgqlc.types.Field(BigDecimal, graphql_name='volumeToken0_not')
    volume_token0_gt = sgqlc.types.Field(BigDecimal, graphql_name='volumeToken0_gt')
    volume_token0_lt = sgqlc.types.Field(BigDecimal, graphql_name='volumeToken0_lt')
...
class Position(sgqlc.types.Type):
    __schema__ = uniswap_v3_schema
    __field_names__ = ('id', 'owner', 'pool', 'token0', 'token1', 'tick_lower', 'tick_upper', 'liquidity', 'deposited_token0', 'deposited_token1', 'withdrawn_token0', 'withdrawn_token1', 'collected_fees_token0', 'collected_fees_token1', 'transaction')
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    owner = sgqlc.types.Field(sgqlc.types.non_null(Bytes), graphql_name='owner')
    pool = sgqlc.types.Field(sgqlc.types.non_null(Pool), graphql_name='pool')
    token0 = sgqlc.types.Field(sgqlc.types.non_null('Token'), graphql_name='token0')
...
class Query(sgqlc.types.Type):
    __schema__ = uniswap_v3_schema
    __field_names__ = ('factory', 'factories', 'bundle', 'bundles', 'token', 'tokens', 'pool', 'pools', 'tick', 'ticks', 'position', 'positions', 'transaction', 'transactions', 'mint', 'mints', 'burn', 'burns', 'swap', 'swaps', 'collect', 'collects', 'flash', 'flashes', 'uniswap_day_data', 'uniswap_day_datas', 'pool_day_data', 'pool_day_datas', 'pool_hour_data', 'pool_hour_datas', 'tick_hour_data', 'tick_hour_datas', 'tick_day_data', 'tick_day_datas', 'token_day_data', 'token_day_datas', 'token_hour_data', 'token_hour_datas', '_meta')
...
class Tick(sgqlc.types.Type):
    __schema__ = uniswap_v3_schema
    __field_names__ = ('id', 'pool_address', 'tick_idx', 'pool', 'liquidity_gross', 'liquidity_net', 'price0', 'price1', 'volume_token0', 'volume_token1', 'volume_usd', 'untracked_volume_usd', 'fees_usd', 'collected_fees_token0', 'collected_fees_token1', 'collected_fees_usd', 'created_at_timestamp', 'created_at_block_number', 'liquidity_provider_count')
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    pool_address = sgqlc.types.Field(String, graphql_name='poolAddress')
...
class TickDayData(sgqlc.types.Type):
    __schema__ = uniswap_v3_schema
    __field_names__ = ('id', 'date', 'pool', 'tick', 'liquidity_gross', 'liquidity_net', 'volume_token0', 'volume_token1', 'volume_usd', 'fees_usd')
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    date = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='date')
    pool = sgqlc.types.Field(sgqlc.types.non_null(Pool), graphql_name='pool')
    tick = sgqlc.types.Field(sgqlc.types.non_null(Tick), graphql_name='tick')
    liquidity_gross = sgqlc.types.Field(sgqlc.types.non_null(BigDecimal), graphql_name='liquidityGross')
    liquidity_net = sgqlc.types.Field(sgqlc.types.non_null(BigDecimal), graphql_name='liquidityNet')
    volume_token0 = sgqlc.types.Field(sgqlc.types.non_null(BigDecimal), graphql_name='volumeToken0')
    volume_token1 = sgqlc.types.Field(sgqlc.types.non_null(BigDecimal), graphql_name='volumeToken1')
    volume_usd = sgqlc.types.Field(sgqlc.types.non_null(BigDecimal), graphql_name='volumeUSD')
    fees_usd = sgqlc.types.Field(sgqlc.types.non_null(BigDecimal), graphql_name='feesUSD')
...
# Schema Entry Points
########################################################################
uniswap_v3_schema.query_type = Query
uniswap_v3_schema.mutation_type = None
uniswap_v3_schema.subscription_type = Subscription
